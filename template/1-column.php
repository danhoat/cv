	...
	<div class="row">
		...
		<div class="col-9 col-right col-content">
			...
			<div class="line skill-line">
				...
				<ul>
					<li>
						<span><strong>Online Comunication</strong> Effective online communication, present compelling messages in a one-way setting in order to be successful.</span></li>

					<li>
						<strong>Time Managment</strong>
						<span>Prioritize my tasks and efficiently organize everything to achieve my goals</span>
					</li>
				</ul>
			</div>
	</div>
